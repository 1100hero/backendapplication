...
public class EmailService implements EmailSender {
    ...
    public static String buildEmailResetPsw(String name, String link) {
        return "<div style=\"align-self:center; width: 100%;background-color: rgb(44, 44, 44); font-family: Arial, sans-serif; margin: 0; padding: 0;\">\n" +
                ...
                "                    <h1 style=\"color: white;margin: 0; font-size: 24px; text-transform: uppercase;\">Modifica password</h1>\n" +
                "                </div>\n" +
                ...
                "                    <p><img src=\"http://techstageit.com/image/techstage.webp\" style=\"max-width: 100%; height: 90px;\"></p>\n" +
                "                </div>\n" +
                "            </div>\n" +
                "        </div>";
    }
